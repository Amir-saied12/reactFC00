        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-8">
                    {api.map((data, ind)=> <div className='col-md-12' key={ind}>
                        <div onMouseEnter={heart} className={`row ${style.colCard} position-relative my-5`}>
                            <img src={data.image} alt="product_img" />
                            <div className={`${style.card_body} ms-4 p-3`}>
                            <a href="#"><span>rate: {data.rating.rate}</span></a>
                                <p><a href='#'>{data.category}</a></p>
                                <p className={`${style.price}`}>{data.price} $</p>
                            </div>
                            <div className={`${style.add}`}>
                                <div className="row">
                                <button>select option</button>
                                <i id='heart' className='fa-solid fa-heart position-absolute top-0 end-0 text-black d-none'></i>
